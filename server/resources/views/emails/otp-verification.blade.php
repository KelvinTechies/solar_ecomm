...
<body>
    <div class="email-container">
        ...
        <div class="header">
            <div class="logo">
                <img src="https://solarvast.com.ng/blog/assets/images/logo/logo_text.png" alt="SolarVast Logo">
            </div>
        ...
        <div class="footer">
            ...
            <div class="social-links">
                <a href="https://solarvast.com.ng" class="social-link">🌐 Visit Website</a>
                <a href="mailto:info@solarvast.com.ng" class="social-link">📧 Contact Support</a>
                <!--<a href="tel:+234-xxx-xxx-xxxx" class="social-link">📞 Call Us</a>-->
            </div>

            <div class="contact-info">
                <p>SolarVast Nigeria | Powering Tomorrow, Today</p>
                <p>📍 Benin City, Nigeria | 📧 info@solarvast.com.ng</p>
                <p style="margin-top: 10px; font-size: 11px;">
                    © 2025 SolarVast. All rights reserved. |
                    <a href="https://solarvast.com.ng/privacy" style="color: #2196F3; text-decoration: none;">Privacy Policy</a> |
                    <a href="https://solarvast.com.ng/terms" style="color: #2196F3; text-decoration: none;">Terms of Service</a>
                </p>
            </div>
        </div>
    </div>
